...
export const loadConfig = async () => {
    ...
    try {
        ...
        throw new Error(`Failed to load AWS configuration: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
};
